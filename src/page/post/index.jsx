            ...
            <div className="post-comment-content-wrap">
                    ...
                    <div className="create-post-comment">
                        <div className='add-post-comment'>
                            <textarea
                                ...
                                onChange={onChange}
                            ></textarea>
                            <button className="post-comment-submit" onClick={submitCommentRevise}>수정</button>
                        </div>
                    </div>
                ) : (
                ...
                <div className="post-comment-footer">
                    ...
                    {userId === currentUserId && (
                        <>
                            <button className="post-comment-action" onClick={toggleCommentRevise}>수정</button>
            ...
            {posts.map((post) => (
                <li key={post.id} className="more-post-item">
                    <div className="more-post-head">
                        {boardName === '자유' ? '' : (<div className="more-post-tag">{post.tag}</div>)}
    ...
    return (
        <div className="modal-report">
            ...
            <div className='report-btn'>
                <button className='submit-report' onClick={handleReportClick}>신고하기</button>
            </div>
        </div>
    );
};
            ...
            <div className="post-content-wrap">
                ...
                <div className="post-title-wrap">
                    <div className="post-title-1">
                        {boardName === '자유' ? '' : (<div className="post-tag">{mockPost.tag}</div>)}
                    ...
                    <div className="post-title-2">
                        ...
                        {mockPost.nickname === currentUserNickname ?
                            ''
                            :
                            <button className="post-follow" onClick={toggleFollows}>팔로우 {isFollow ? <GreenCheckIcon /> : '+'}</button>
                        }
                ...
                <div className="post-btn">
                    ...
                    <div className="post-btn2">
                        {mockPost.nickname === currentUserNickname ? (
                            <>
                                <button onClick={handlePostReviseClick}>수정</button>|<button>삭제</button>|
                            </>
                        ) : (
                            <>
                                <button
            ...
            <div className="post-comment">
                ...
                {mockPost.comment.map((comment, index) => (
                    <Comment
                        ...
                        toggleReportModal={() => toggleReportModal(comment.nickname, comment.content)}
                        commentIndex={index}
